...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    module.exports = factory(require('sib-api-v3-sdk/src/ApiClient'), require('sib-api-v3-sdk/src/model/CreateModel'), require('sib-api-v3-sdk/src/model/CreateSmsCampaign'), require('sib-api-v3-sdk/src/model/CreatedProcessId'), require('sib-api-v3-sdk/src/model/ErrorModel'), require('sib-api-v3-sdk/src/model/GetSmsCampaign'), require('sib-api-v3-sdk/src/model/GetSmsCampaigns'), require('sib-api-v3-sdk/src/model/PostSendSmsTestFailed'), require('sib-api-v3-sdk/src/model/RequestSmsRecipientExport'), require('sib-api-v3-sdk/src/model/SendReport'), require('sib-api-v3-sdk/src/model/SendTestSms'), require('sib-api-v3-sdk/src/model/UpdateCampaignStatus'), require('sib-api-v3-sdk/src/model/UpdateSmsCampaign'));
  } else {
