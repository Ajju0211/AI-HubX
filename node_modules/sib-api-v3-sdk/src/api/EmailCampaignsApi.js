...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    module.exports = factory(require('sib-api-v3-sdk/src/ApiClient'), require('sib-api-v3-sdk/src/model/AbTestCampaignResult'), require('sib-api-v3-sdk/src/model/CreateEmailCampaign'), require('sib-api-v3-sdk/src/model/CreateModel'), require('sib-api-v3-sdk/src/model/CreatedProcessId'), require('sib-api-v3-sdk/src/model/EmailExportRecipients'), require('sib-api-v3-sdk/src/model/ErrorModel'), require('sib-api-v3-sdk/src/model/GetEmailCampaign'), require('sib-api-v3-sdk/src/model/GetEmailCampaigns'), require('sib-api-v3-sdk/src/model/GetSharedTemplateUrl'), require('sib-api-v3-sdk/src/model/PostSendFailed'), require('sib-api-v3-sdk/src/model/SendReport'), require('sib-api-v3-sdk/src/model/SendTestEmail'), require('sib-api-v3-sdk/src/model/UpdateCampaignStatus'), require('sib-api-v3-sdk/src/model/UpdateEmailCampaign'), require('sib-api-v3-sdk/src/model/UploadImageModel'), require('sib-api-v3-sdk/src/model/UploadImageToGallery'));
  } else {
