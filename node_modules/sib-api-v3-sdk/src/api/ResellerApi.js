...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    module.exports = factory(require('sib-api-v3-sdk/src/ApiClient'), require('sib-api-v3-sdk/src/model/AddChildDomain'), require('sib-api-v3-sdk/src/model/AddCredits'), require('sib-api-v3-sdk/src/model/CreateChild'), require('sib-api-v3-sdk/src/model/CreateReseller'), require('sib-api-v3-sdk/src/model/ErrorModel'), require('sib-api-v3-sdk/src/model/GetChildAccountCreationStatus'), require('sib-api-v3-sdk/src/model/GetChildDomains'), require('sib-api-v3-sdk/src/model/GetChildInfo'), require('sib-api-v3-sdk/src/model/GetChildrenList'), require('sib-api-v3-sdk/src/model/GetSsoToken'), require('sib-api-v3-sdk/src/model/ManageIp'), require('sib-api-v3-sdk/src/model/RemainingCreditModel'), require('sib-api-v3-sdk/src/model/RemoveCredits'), require('sib-api-v3-sdk/src/model/UpdateChild'), require('sib-api-v3-sdk/src/model/UpdateChildAccountStatus'), require('sib-api-v3-sdk/src/model/UpdateChildDomain'));
  } else {
