...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    module.exports = factory(require('sib-api-v3-sdk/src/ApiClient'), require('sib-api-v3-sdk/src/model/AddContactToList'), require('sib-api-v3-sdk/src/model/CreateAttribute'), require('sib-api-v3-sdk/src/model/CreateContact'), require('sib-api-v3-sdk/src/model/CreateDoiContact'), require('sib-api-v3-sdk/src/model/CreateList'), require('sib-api-v3-sdk/src/model/CreateModel'), require('sib-api-v3-sdk/src/model/CreateUpdateContactModel'), require('sib-api-v3-sdk/src/model/CreateUpdateFolder'), require('sib-api-v3-sdk/src/model/CreatedProcessId'), require('sib-api-v3-sdk/src/model/ErrorModel'), require('sib-api-v3-sdk/src/model/GetAttributes'), require('sib-api-v3-sdk/src/model/GetContactCampaignStats'), require('sib-api-v3-sdk/src/model/GetContacts'), require('sib-api-v3-sdk/src/model/GetExtendedContactDetails'), require('sib-api-v3-sdk/src/model/GetExtendedList'), require('sib-api-v3-sdk/src/model/GetFolder'), require('sib-api-v3-sdk/src/model/GetFolderLists'), require('sib-api-v3-sdk/src/model/GetFolders'), require('sib-api-v3-sdk/src/model/GetLists'), require('sib-api-v3-sdk/src/model/PostContactInfo'), require('sib-api-v3-sdk/src/model/RemoveContactFromList'), require('sib-api-v3-sdk/src/model/RequestContactExport'), require('sib-api-v3-sdk/src/model/RequestContactImport'), require('sib-api-v3-sdk/src/model/UpdateAttribute'), require('sib-api-v3-sdk/src/model/UpdateBatchContacts'), require('sib-api-v3-sdk/src/model/UpdateBatchContactsModel'), require('sib-api-v3-sdk/src/model/UpdateContact'), require('sib-api-v3-sdk/src/model/UpdateList'));
  } else {
