...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    module.exports = factory(require('sib-api-v3-sdk/src/ApiClient'), require('sib-api-v3-sdk/src/model/CreateSubAccount'), require('sib-api-v3-sdk/src/model/CreateSubAccountResponse'), require('sib-api-v3-sdk/src/model/ErrorModel'), require('sib-api-v3-sdk/src/model/GetSsoToken'), require('sib-api-v3-sdk/src/model/MasterDetailsResponse'), require('sib-api-v3-sdk/src/model/SsoTokenRequest'), require('sib-api-v3-sdk/src/model/SubAccountDetailsResponse'), require('sib-api-v3-sdk/src/model/SubAccountUpdatePlanRequest'), require('sib-api-v3-sdk/src/model/SubAccountsResponse'));
  } else {
