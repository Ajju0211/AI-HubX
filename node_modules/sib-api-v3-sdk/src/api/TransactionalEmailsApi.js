...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    module.exports = factory(require('sib-api-v3-sdk/src/ApiClient'), require('sib-api-v3-sdk/src/model/BlockDomain'), require('sib-api-v3-sdk/src/model/CreateModel'), require('sib-api-v3-sdk/src/model/CreateSmtpEmail'), require('sib-api-v3-sdk/src/model/CreateSmtpTemplate'), require('sib-api-v3-sdk/src/model/DeleteHardbounces'), require('sib-api-v3-sdk/src/model/ErrorModel'), require('sib-api-v3-sdk/src/model/GetAggregatedReport'), require('sib-api-v3-sdk/src/model/GetBlockedDomains'), require('sib-api-v3-sdk/src/model/GetEmailEventReport'), require('sib-api-v3-sdk/src/model/GetReports'), require('sib-api-v3-sdk/src/model/GetScheduledEmailByBatchId'), require('sib-api-v3-sdk/src/model/GetScheduledEmailByMessageId'), require('sib-api-v3-sdk/src/model/GetSmtpTemplateOverview'), require('sib-api-v3-sdk/src/model/GetSmtpTemplates'), require('sib-api-v3-sdk/src/model/GetTransacBlockedContacts'), require('sib-api-v3-sdk/src/model/GetTransacEmailContent'), require('sib-api-v3-sdk/src/model/GetTransacEmailsList'), require('sib-api-v3-sdk/src/model/PostSendFailed'), require('sib-api-v3-sdk/src/model/ScheduleSmtpEmail'), require('sib-api-v3-sdk/src/model/SendSmtpEmail'), require('sib-api-v3-sdk/src/model/SendTestEmail'), require('sib-api-v3-sdk/src/model/UpdateSmtpTemplate'));
  } else {
