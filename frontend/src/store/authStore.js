...
const API_URL = import.meta.env.MODE === 'production' ? `${import.meta.env.VITE_API_URL}/api/auth` :  "http://localhost:3000/api/auth";

const API_URL_CHAT =  import.meta.env.MODE === 'production' ?  `${import.meta.env.VITE_API_URL}/api/chat` : "http://localhost:3000/api/chat";
