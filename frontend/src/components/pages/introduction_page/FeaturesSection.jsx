...
export function FeatureSection() {
  const features = [
  {
    ...
    description:
      "Write, debug, and optimize code in multiple languages using our intelligent code generation engine powered by large language models.",
  ...
  },
  {
    ...
    description:
      "Turn simple text prompts into stunning images using cutting-edge generative AI models with multi-style support.",
    skeleton: <SkeletonTwo />,
    className: "border-b col-span-1 lg:col-span-2 dark:border-neutral-800",
  },
  {
    title: "Have Conversations with AI",
    description:
      "Chat naturally with AI that understands context, answers questions, explains code, and acts like a virtual assistant.",
  ...
  },
  {
    ...
    description:
      "Interact with multiple AI capabilities—code, image, and conversation—under one seamless, user-friendly platform built for speed and scalability.",
...
export const SkeletonFour = () => {
  return (
    <div
      ...
      <ModelsAnimation className="absolute -right-10 md:-right-10 -bottom-80 md:-bottom-72" />
    </div>
  );
};
