...
const GetStarted = () => {
  ...
  return (
    <div className="w-full  mb-8 min-h-[300px] bg-black text-[#e5e4e4] flex flex-col items-center justify-center  py-10">
      <div className=' border-[1px] min-h-[300px] p-12 border-dashed rounded-md ml-4 mr-4 relative'>
