...
const formatResponse = (text) => {
    return text
        .replace(/## (.+?)\n/g, '<h1 class="text-2xl font-semibold text-[#e5e4e4] w-full mb">$1</h1>')
        ...
        .replace(/(https?:\/\/.*\.(?:png|jpg|jpeg|gif|webp|svg))/gi, '<img src="$1" alt="Generated Image" class="w-96 rounded-lg mt-2" />'); // Image support
};
