...
// node_modules/react-code-block/dist/shared/utils.js
...
var splitStringByWords = (str, words) => {
  return str.split(new RegExp(`(${words.map(([word]) => word).join("|")})`)).filter(Boolean);
};
...
var createUseContext = (context, errMessage) => () => {
...
var forwardRef = (component) => {
  return Object.assign((0, import_react5.forwardRef)(component), {
    displayName: component.displayName ?? component.name
  });
};

// node_modules/react-code-block/dist/contexts.js
var RootContext = (0, import_react6.createContext)(void 0);
var LineContext = (0, import_react6.createContext)(void 0);
var useRootContext = createUseContext(RootContext, 'Could not find nearest <CodeBlock /> component. Please wrap this component with a <CodeBlock /> component imported from "react-code-block".');
var useLineContext = createUseContext(LineContext, 'Could not find nearest <CodeBlock.Code /> component. Please wrap this component with <CodeBlock.Code /> component imported from "react-code-block".');

// node_modules/react-code-block/dist/code-block.js
var CodeBlock = ({ code, words = [], lines = [], children, ...props }) => {
  const parsedWords = (0, import_react7.useMemo)(() => parseWordHighlights(words), [words]);
...
var Token = ({ as, children = ({ children: children2 }) => (0, import_jsx_runtime.jsx)("span", { children: children2 }), className, ...rest }, ref) => {
  ...
  const Tag = as ?? "span";
  return (0, import_jsx_runtime.jsx)(import_react7.default.Fragment, { children: line.map((token, key) => {
    const { children: contentWithSpaces, ...props } = getTokenProps({
      token,
      className
    });
    const content = words.length ? splitStringByWords(contentWithSpaces, words) : [contentWithSpaces];
    return (0, import_jsx_runtime.jsx)(import_react7.default.Fragment, { children: content.map((content2, i) => (0, import_jsx_runtime.jsx)(Tag, { ...props, ...rest, ref, children: children({
      children: content2,
